...
private:
	...
	GameTimer gt;
	//GameTimer gt is used to set and allow for the dynamic usage of the frame time (functionally making it so aspects such as movement is capped by your set framerate - in this case, 60)
	ObjectManager ObjectManager;
	//Creating a local instance of the ObjectManager so it can be used here, without increasing the dependencies within the program by #Including it
public:
